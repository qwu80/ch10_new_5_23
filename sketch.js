...
function draw() {
  ...
  if (sceneCount == 0.5) {
    ...
    if (time_count ==0) {
      ...
      generation_Rate_c = 2*0.01*Math.pow(ni,2)/(((current_Electron_c+10156647780494.508-7338419761646.086)+ni)+((current_Hole_c+28531+2216443226646)+ni));
  ...
  //temp draw
    ...
    text(temp+"K",(70+140)*s_x,(640+115)*s_y)
      ...
      //generation_Rate_c 270-1792 400-30197251824
      // generation_Rate_c = temp*232286538.7076923-62717363659.07692
...
resetGraph= () => {
  ...
  settings.nucleus1 = document.querySelector('#nuclei-freeze1').checked;
  settings.nucleus2 = document.querySelector('#nuclei-freeze2').checked;
  settings.nucleus3 = document.querySelector('#nuclei-freeze3').checked;

  // settings.nn = document.querySelector('#nn').checked;
  // settings.kk = document.querySelector('#kk').checked;

  if (settings.nucleus1 == true){
    settings.nucleus = true

  } else {
    settings.nucleus = false
    
  }

  if (settings.nucleus2 == true){
    settings.nn = true
  } else {
    settings.nn = false
  }
  if (settings.nucleus3 == true){
    settings.kk = true
  } else {
    settings.kk = false
  }
